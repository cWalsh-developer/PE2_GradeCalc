...
function calculateGrades()
{
  ...
  var testMarkL5M1 = parseFloat(document.getElementById("testInputL5M1").value) || 0;
  var quizMarkL5M1 = parseFloat(document.getElementById("quizInputL5M1").value) || 0;
  var courseworkMarkL5M1 = parseFloat(document.getElementById("courseworkInputL5M1").value) || 0;

  var testMarkL5M2 = parseFloat(document.getElementById("testInputL5M2").value) || 0;
  var quizMarkL5M2 = parseFloat(document.getElementById("quizInputL5M2").value) || 0;
  var courseworkMarkL5M2 = parseFloat(document.getElementById("courseworkInputL5M2").value) || 0;

  var testMarkL5M3 = parseFloat(document.getElementById("testInputL5M3").value) || 0;
  var quizMarkL5M3 = parseFloat(document.getElementById("quizInputL5M3").value) || 0;
  var courseworkMarkL5M3 = parseFloat(document.getElementById("courseworkInputL5M3").value) || 0;


  var testMarkL5M4 = parseFloat(document.getElementById("testInputL5M4").value) || 0;
  var quizMarkL5M4 = parseFloat(document.getElementById("quizInputL5M4").value) || 0;
  var courseworkMarkL5M4 = parseFloat(document.getElementById("courseworkInputL5M4").value) || 0;
  ...
  // For testMarkL6M1, quizMarkL6M1, courseworkMarkL6M1
  var testMarkL6M1 = parseFloat(document.getElementById("testInputL6M1").value) || 0;
  var quizMarkL6M1 = parseFloat(document.getElementById("quizInputL6M1").value) || 0;
  var courseworkMarkL6M1 = parseFloat(document.getElementById("courseworkInputL6M1").value) || 0;

  // Repeat the same for testMarkL6M2, quizMarkL6M2, courseworkMarkL6M2, etc.

  // For testMarkL6M2, quizMarkL6M2, courseworkMarkL6M2
  var testMarkL6M2 = parseFloat(document.getElementById("testInputL6M2").value) || 0;
  var quizMarkL6M2 = parseFloat(document.getElementById("quizInputL6M2").value) || 0;
  var courseworkMarkL6M2 = parseFloat(document.getElementById("courseworkInputL6M2").value) || 0;

  // Repeat the same for testMarkL6M3, quizMarkL6M3, courseworkMarkL6M3

  // For testMarkL6M3, quizMarkL6M3, courseworkMarkL6M3
  var testMarkL6M3 = parseFloat(document.getElementById("testInputL6M3").value) || 0;
  var quizMarkL6M3 = parseFloat(document.getElementById("quizInputL6M3").value) || 0;
  var courseworkMarkL6M3 = parseFloat(document.getElementById("courseworkInputL6M3").value) || 0;

  // Repeat the same for testMarkL6M4, quizMarkL6M4, courseworkMarkL6M4

  // For testMarkL6M4, quizMarkL6M4, courseworkMarkL6M4
  var testMarkL6M4 = parseFloat(document.getElementById("testInputL6M4").value) || 0;
  var quizMarkL6M4 = parseFloat(document.getElementById("quizInputL6M4").value) || 0;
  var courseworkMarkL6M4 = parseFloat(document.getElementById("courseworkInputL6M4").value) || 0;
...
function calculatePrediction()
{
    ...
    var final_year_planning = document.getElementById("final_year_planning");
    ...
    if(final_year_planning.checked){
